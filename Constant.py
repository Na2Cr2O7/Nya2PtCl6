...
NYANAME='氯铂酸喵3' # 机器人昵称
NYANAMES=[NYANAME,'2氯铂酸喵Nya2PtCl6'] # 机器人昵称列表
#VERSION='3.2A' # 版本号
...
def getAnswerIn2(question,image):
    return getAnswerUtil.getAnswer(question,image)
def getAnswerbyOllama(question,image):
    return getAnswerUtil.getAnswerbyOllama(question,image)
...
MODELSBYDAY=['jingyaogong/minimind2'] # 日常模式模型'qwen2.5:1.5b','qwen2:1.5b','qwen:1.8b','qwen2.5:0.5b','qwen2:0.5b'
MODELSBYNIGHT=['jingyaogong/minimind2'] # 夜间模式模型'qwen2.5:0.5b',
MODELSATDAY=MODELSBYDAY 
MODELSATNIGHT=MODELSBYNIGHT

#VISIONMODEL='huihui_ai/granite3.2-vision-abliterated:latest' # 视觉模型
DOTRANSLATE=True # 是否翻译
TRANSLATE=DOTRANSLATE # 是否翻译
PACKAGE=r'com.mihoyo.hyperion' # 包名
